...
do_reload_config (GSimpleAction *self, GVariant *parameter, gpointer user_data)
{
	...
	for (int i = 0; i < terms.n_active; i++) {
		if (terms.active[i].term) {
			...
			//vte_terminal_set_geometry_hints_for_window(VTE_TERMINAL (terms.active[i].term), GTK_WINDOW (windows[terms.active[i].window].window));
		}
	}
...
void
do_copy (GSimpleAction *self, GVariant *parameter, gpointer data)
{
...
void
do_t_decorate (GSimpleAction *self, GVariant *parameter, gpointer data)
{
	long int i = (long int) data;
...
void
do_t_fullscreen (GSimpleAction *self, GVariant *parameter, gpointer data)
{
	long int i = (long int) data;
...
void
do_t_tabbar (GSimpleAction *self, GVariant *parameter, gpointer data)
{
	long int i = (long int) data;
...
void
do_show_terms (GSimpleAction *self, GVariant *parameter, gpointer data)
{
...
void
do_next_term (GSimpleAction *self, GVariant *parameter, gpointer data)
{
	long int i = (long int) data;
...
void
do_prev_term (GSimpleAction *self, GVariant *parameter, gpointer data)
{
	long int i = (long int) data;
...
void
do_move_to_window (GSimpleAction *self, GVariant *parameter, gpointer data)
{
...
void
do_set_window_color_scheme (GSimpleAction *self, GVariant *parameter, gpointer data)
{
...
rebuild_window_menu(long int window_n)
{
	...
	z_menu_append(terminals, add_actions, &n_add_actions, "menu.", "_Previous Terminal", "prev_terminal", do_prev_term, window_n);
	...
	z_menu_append(config, add_actions, &n_add_actions, "menu.", "_Reload config file", "reload_config", do_reload_config, window_n);
